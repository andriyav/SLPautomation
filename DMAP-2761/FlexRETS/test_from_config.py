        ...
        for source in sources:
            ...
            for clas in range(1, classes):
                with self.subTest(source=source):
                    try:
                        metadata_checker(source, "lease_price", 6, clas, "LIST_22")
                        metadata_checker(source, "lease_price", 6, clas, "LIST_8")
                        ...
                        try:
                            ...
                            wrong_mapped.append(source + f" class {clas}-{actual[2][clas]}")
